...
class Dstream {
	typedef hash_map<string, GlobalGrid, str_hash> hashMap;
	typedef hashMap::iterator hashMapIt;
	typedef hash_map<string,LocalGrid,str_hash >localHashMap;
	...
	int resultdata(vector<string> &index ,double & ssq,double & weightedSSQ,double & purity,double & correctedRate,double & weightedPurity ,string &type);
