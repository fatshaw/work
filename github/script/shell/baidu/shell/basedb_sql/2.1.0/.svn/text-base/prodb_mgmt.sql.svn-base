...
--
-- Table structure for table `account_inapprove`
--

DROP TABLE IF EXISTS `account_inapprove`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `account_inapprove` (
  `id` bigint(20) NOT NULL COMMENT '记录自增id',
  `uc_id` bigint(20) NOT NULL DEFAULT '0' COMMENT 'ucid',
  `uc_name` varchar(255) NOT NULL COMMENT 'ucname',
  `role_id` bigint(20) DEFAULT '2' COMMENT '角色id',
  `add_time` datetime NOT NULL COMMENT '记录添加时间',
  `update_time` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '记录更新时间,自动更新',
  `contact_name` varchar(255) DEFAULT NULL COMMENT 'UC账户联系人',
  `contact_email` varchar(255) DEFAULT NULL COMMENT '联系人邮件地址',
  `type_id` bigint(20) DEFAULT '1' COMMENT '账号类型id',
  `status` tinyint(3) DEFAULT '1' COMMENT '表示帐号状态，1为待审核，2为拒绝,3，为通过',
  `merchant_name` varchar(255) DEFAULT '' COMMENT '广告主公司名称',
...
CREATE TABLE `account_product_user` (
  ...
  `merchant_id` bigint(20) NOT NULL COMMENT '所属公司',
  PRIMARY KEY (`uc_id`),
  UNIQUE KEY `uc_name` (`uc_name`),
  KEY `id` (`id`),
  KEY `user_role` (`role_id`),
...
CREATE TABLE `feed` (
  ...
  `warning_import_number` int(11) DEFAULT '0' COMMENT '更新结果：警告数',
  `error_import_number` int(11) DEFAULT '0' COMMENT '更新结果：错误数',
  `owner_id` bigint(20) NOT NULL COMMENT 'feed所属的注册ucid',
  `operator_id` bigint(20) NOT NULL COMMENT 'feed最后操作者ucid',
  PRIMARY KEY (`id`),
...
--
-- Table structure for table `feed_category_config`
--

DROP TABLE IF EXISTS `feed_category_config`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `feed_category_config` (
  `id` bigint(20) unsigned NOT NULL,
  `category_id` bigint(20) NOT NULL DEFAULT '0' COMMENT 'category id in feed',
  `category_name` varchar(255) NOT NULL DEFAULT '''''',
  `feed_type` enum('TuanBai') NOT NULL DEFAULT 'TuanBai',
  PRIMARY KEY (`id`)
);
/*!40101 SET character_set_client = @saved_cs_client */;
...
--
-- Table structure for table `import_step_monitor`
--

DROP TABLE IF EXISTS `import_step_monitor`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `import_step_monitor` (
  `id` bigint(20) unsigned NOT NULL,
  `task_id` bigint(20) NOT NULL DEFAULT '0',
  `feed_id` bigint(20) NOT NULL DEFAULT '0',
  `is_subtask` bit(1) NOT NULL DEFAULT b'0' COMMENT '是否为subtask。1代表是subtask，0代表不是subtask',
  `subtask_id` bigint(20) NOT NULL DEFAULT '0',
  `step_type` enum('IMPORT','PARSE','FETCH') NOT NULL DEFAULT 'FETCH',
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `task_id, step_type, sbutask_id` (`task_id`,`step_type`,`subtask_id`),
  KEY `end_time` (`end_time`)
);
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Table structure for table `import_task_monitor`
--

DROP TABLE IF EXISTS `import_task_monitor`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `import_task_monitor` (
  `id` bigint(20) unsigned NOT NULL,
  `task_id` bigint(20) NOT NULL DEFAULT '0',
  `subtask_id` bigint(20) NOT NULL DEFAULT '0',
  `start_time` timestamp NOT NULL DEFAULT '0000-00-00 00:00:00',
  `end_time` timestamp NOT NULL DEFAULT '0000-00-00 00:00:00',
  `waiting_time` time NOT NULL DEFAULT '00:00:00',
  `waiting_parse_time` time NOT NULL DEFAULT '00:00:00',
  `waiting_import_time` time NOT NULL DEFAULT '00:00:00',
  `parse_to_import_time` time NOT NULL DEFAULT '00:00:00',
  `addtime` timestamp NOT NULL DEFAULT '0000-00-00 00:00:00',
  `updatetime` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`),
  UNIQUE KEY `task_id, subtask_id` (`task_id`,`subtask_id`),
  KEY `end_time` (`end_time`)
);
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Table structure for table `mcc_cache`
--

DROP TABLE IF EXISTS `mcc_cache`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `mcc_cache` (
  `uc_id` bigint(20) NOT NULL COMMENT '索引ucid',
  `bind_ids` varchar(2048) NOT NULL COMMENT '绑定ucids',
  `update_time` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '记录更新时间,自动更新',
  `registed_ucid` bigint(20) NOT NULL COMMENT '注册使用的ucid',
  PRIMARY KEY (`uc_id`),
  KEY `registed_ucid` (`registed_ucid`)
);
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `merchant` (
  ...
  `display_name` varchar(255) DEFAULT 'defaut' COMMENT '广告主显示公司名称',
  ...
  `merchant_type` enum('TEST','NORMAL','ADMIN') NOT NULL DEFAULT 'NORMAL' COMMENT 'merchant type',
  PRIMARY KEY (`id`),
  KEY `id` (`id`)
);
/*!40101 SET character_set_client = @saved_cs_client */;
