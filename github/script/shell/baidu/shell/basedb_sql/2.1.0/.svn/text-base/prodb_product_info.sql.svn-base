...
--
-- Host: 10.36.55.57    Database: prodb_product_info
-- ------------------------------------------------------
...
CREATE TABLE `api_log` (
  ...
  `apiname` text COMMENT 'api name',
  `token` varchar(255) DEFAULT NULL COMMENT 'token of requester',
  `clientIP` varchar(255) DEFAULT NULL COMMENT 'ip of requester',
  `apiendtime` timestamp NULL DEFAULT NULL COMMENT 'visit time of request',
  `params` mediumtext COMMENT 'parameters of request',
  `servreturntype` varchar(255) DEFAULT NULL COMMENT 'return type of response',
  `servreturnstring` mediumtext COMMENT 'return information of response',
  `entertime` timestamp NULL DEFAULT NULL,
  `lefttime` timestamp NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=5289341 DEFAULT CHARSET=utf8 COMMENT='record information about webservice api request and response';
...
--
-- Table structure for table `berries_change_product_task`
--

DROP TABLE IF EXISTS `berries_change_product_task`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `berries_change_product_task` (
...
--
-- Table structure for table `berries_error_product`
--

DROP TABLE IF EXISTS `berries_error_product`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `berries_error_product` (
  `id` bigint(20) unsigned NOT NULL AUTO_INCREMENT,
  `productid` bigint(20) NOT NULL,
  `feedid` bigint(20) NOT NULL,
...
--
-- Table structure for table `berries_product_attribute`
--

DROP TABLE IF EXISTS `berries_product_attribute`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `berries_product_attribute` (
...
--
-- Table structure for table `berries_product_feed`
--

DROP TABLE IF EXISTS `berries_product_feed`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `berries_product_feed` (
  `id` bigint(20) unsigned NOT NULL AUTO_INCREMENT,
  `productid` bigint(20) NOT NULL,
  `feedid` bigint(20) NOT NULL,
  `name` varchar(100) DEFAULT NULL,
...
--
-- Table structure for table `berries_product_image`
--

DROP TABLE IF EXISTS `berries_product_image`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `berries_product_image` (
  `id` bigint(20) unsigned NOT NULL AUTO_INCREMENT,
...
) ENGINE=InnoDB AUTO_INCREMENT=957366 DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Table structure for table `berries_product_info`
--

DROP TABLE IF EXISTS `berries_product_info`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `berries_product_info` (
...
--
-- Table structure for table `berries_product_line_validation`
--

DROP TABLE IF EXISTS `berries_product_line_validation`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `berries_product_line_validation` (
  `id` bigint(20) unsigned NOT NULL AUTO_INCREMENT,
  `productid` bigint(20) NOT NULL,
  ...
  UNIQUE KEY `validation` (`productid`,`product_lineid`),
...
CREATE TABLE `bw_updatetime_tracking` (
  ...
  `istestdb` tinyint(4) DEFAULT NULL COMMENT 'is test db',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=1135888 DEFAULT CHARSET=utf8 COMMENT='track last update ation';
/*!40101 SET character_set_client = @saved_cs_client */;
...
--
-- Table structure for table `ctvonline_change_product_task`
--

DROP TABLE IF EXISTS `ctvonline_change_product_task`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `ctvonline_change_product_task` (
  `id` bigint(20) unsigned NOT NULL AUTO_INCREMENT,
  `productid` bigint(20) NOT NULL,
  `feedid` bigint(20) NOT NULL,
  `tasktype` enum('delete','update','add') DEFAULT NULL,
...
--
-- Table structure for table `ctvonline_error_product`
--

DROP TABLE IF EXISTS `ctvonline_error_product`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `ctvonline_error_product` (
  `id` bigint(20) unsigned NOT NULL AUTO_INCREMENT,
  `productid` bigint(20) NOT NULL,
  `feedid` bigint(20) NOT NULL,
  `ucid` bigint(20) NOT NULL DEFAULT '0' COMMENT 'uc user id',
...
--
-- Table structure for table `ctvonline_product_attribute`
--

DROP TABLE IF EXISTS `ctvonline_product_attribute`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `ctvonline_product_attribute` (
  `id` bigint(20) NOT NULL,
  `productid` bigint(20) NOT NULL,
  `name` varchar(255) DEFAULT NULL,
  `value` text,
...
--
-- Table structure for table `ctvonline_product_feed`
--

DROP TABLE IF EXISTS `ctvonline_product_feed`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `ctvonline_product_feed` (
  `id` bigint(20) unsigned NOT NULL AUTO_INCREMENT,
  `productid` bigint(20) NOT NULL,
  `feedid` bigint(20) NOT NULL,
  `name` varchar(100) DEFAULT NULL,
...
--
-- Table structure for table `ctvonline_product_image`
--

DROP TABLE IF EXISTS `ctvonline_product_image`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `ctvonline_product_image` (
  `id` bigint(20) unsigned NOT NULL AUTO_INCREMENT,
  `productid` bigint(20) DEFAULT NULL,
  `imageUrl` varchar(1024) DEFAULT NULL,
  `imageBCSUrl` varchar(1024) DEFAULT NULL,
  ...
  KEY `imageurl` (`imageUrl`(255)),
  KEY `threadid_status_failtimes` (`threadid`,`status`,`failtimes`)
) ENGINE=InnoDB AUTO_INCREMENT=869178 DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Table structure for table `ctvonline_product_info`
--

DROP TABLE IF EXISTS `ctvonline_product_info`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `ctvonline_product_info` (
  `id` bigint(20) unsigned NOT NULL,
  `feedid` bigint(20) unsigned NOT NULL,
  `name` varchar(255) NOT NULL,
  `title` text NOT NULL,
...
--
-- Table structure for table `ctvonline_product_line_validation`
--

DROP TABLE IF EXISTS `ctvonline_product_line_validation`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `ctvonline_product_line_validation` (
  `id` bigint(20) unsigned NOT NULL AUTO_INCREMENT,
  `productid` bigint(20) NOT NULL,
  `product_lineid` int(11) NOT NULL,
  `status` enum('error','warning','normal','unchecked') NOT NULL DEFAULT 'unchecked',
...
CREATE TABLE `dianping_product_image` (
  ...
  KEY `imageurl` (`imageUrl`(255)) USING BTREE,
  KEY `threadid_status_failtimes` (`threadid`,`status`,`failtimes`)
) ENGINE=InnoDB AUTO_INCREMENT=1049607 DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `dianping_product_line_validation` (
  ...
  UNIQUE KEY `validation` (`productid`,`product_lineid`),
  KEY `product_line` (`product_lineid`)
) ENGINE=InnoDB AUTO_INCREMENT=16990065 DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Table structure for table `elong_change_product_task`
--

DROP TABLE IF EXISTS `elong_change_product_task`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `elong_change_product_task` (
  `id` bigint(20) unsigned NOT NULL AUTO_INCREMENT,
  `productid` bigint(20) NOT NULL,
  `feedid` bigint(20) NOT NULL,
  `tasktype` enum('delete','update','add') DEFAULT NULL,
...
--
-- Table structure for table `elong_error_product`
--

DROP TABLE IF EXISTS `elong_error_product`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `elong_error_product` (
  `id` bigint(20) unsigned NOT NULL AUTO_INCREMENT,
  `productid` bigint(20) NOT NULL,
  `feedid` bigint(20) NOT NULL,
  `ucid` bigint(20) NOT NULL DEFAULT '0' COMMENT 'uc user id',
...
--
-- Table structure for table `elong_product_attribute`
--

DROP TABLE IF EXISTS `elong_product_attribute`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `elong_product_attribute` (
  `id` bigint(20) NOT NULL,
  `productid` bigint(20) NOT NULL,
  `name` varchar(255) DEFAULT NULL,
  `value` text,
...
--
-- Table structure for table `elong_product_feed`
--

DROP TABLE IF EXISTS `elong_product_feed`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `elong_product_feed` (
  `id` bigint(20) unsigned NOT NULL AUTO_INCREMENT,
  `productid` bigint(20) NOT NULL,
  `feedid` bigint(20) NOT NULL,
  `name` varchar(100) DEFAULT NULL,
...
--
-- Table structure for table `elong_product_image`
--

DROP TABLE IF EXISTS `elong_product_image`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `elong_product_image` (
  `id` bigint(20) unsigned NOT NULL AUTO_INCREMENT,
  `productid` bigint(20) DEFAULT NULL,
  `imageUrl` varchar(1024) DEFAULT NULL,
  `imageBCSUrl` varchar(1024) DEFAULT NULL,
...
--
-- Table structure for table `elong_product_info`
--

DROP TABLE IF EXISTS `elong_product_info`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `elong_product_info` (
  `id` bigint(20) unsigned NOT NULL,
  `feedid` bigint(20) unsigned NOT NULL,
  `name` varchar(255) NOT NULL,
  `title` text NOT NULL,
...
--
-- Table structure for table `elong_product_line_validation`
--

DROP TABLE IF EXISTS `elong_product_line_validation`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `elong_product_line_validation` (
  `id` bigint(20) unsigned NOT NULL AUTO_INCREMENT,
  `productid` bigint(20) NOT NULL,
  `product_lineid` int(11) NOT NULL,
  `status` enum('error','warning','normal','unchecked') NOT NULL DEFAULT 'unchecked',
...
--
-- Table structure for table `inactive_product_feed`
--

DROP TABLE IF EXISTS `inactive_product_feed`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `inactive_product_feed` (
  `id` bigint(20) unsigned NOT NULL AUTO_INCREMENT,
  `productid` bigint(20) NOT NULL,
  `feedid` bigint(20) NOT NULL,
  `name` varchar(100) DEFAULT NULL,
...
CREATE TABLE `inactive_product_image` (
  ...
  `recordupdatetime` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=64222 DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
--
-- Table structure for table `inactive_product_line_validation`
--

DROP TABLE IF EXISTS `inactive_product_line_validation`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `inactive_product_line_validation` (
  `id` bigint(20) unsigned NOT NULL AUTO_INCREMENT,
  `productid` bigint(20) NOT NULL,
  `product_lineid` int(11) NOT NULL,
  `status` enum('error','warning','normal','unchecked') NOT NULL DEFAULT 'unchecked',
  ...
  `recordupdatetime` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=32322 DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `index_helper` (
  ...
  KEY `active` (`active`),
  KEY `deleted_feedid_active_status` (`deleted`,`feed_id`,`status`,`active`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `kongyue_product_image` (
  ...
  KEY `imageurl` (`imageUrl`(255)) USING BTREE,
  KEY `threadid_status_failtimes` (`threadid`,`status`,`failtimes`)
) ENGINE=InnoDB AUTO_INCREMENT=870640 DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `lashou_product_image` (
  ...
  KEY `imageurl` (`imageUrl`(255)) USING BTREE,
  KEY `threadid_status_failtimes` (`threadid`,`status`,`failtimes`)
) ENGINE=InnoDB AUTO_INCREMENT=1051251 DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `lashou_product_line_validation` (
  ...
  UNIQUE KEY `validation` (`productid`,`product_lineid`),
  KEY `product_line` (`product_lineid`)
) ENGINE=InnoDB AUTO_INCREMENT=41516212 DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `meilele_product_image` (
  ...
  KEY `imageurl` (`imageUrl`(255)) USING BTREE,
  KEY `threadid_status_failtimes` (`threadid`,`status`,`failtimes`)
) ENGINE=InnoDB AUTO_INCREMENT=1051012 DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `meilele_product_line_validation` (
  ...
  UNIQUE KEY `validation` (`productid`,`product_lineid`),
  KEY `product_line` (`product_lineid`)
) ENGINE=InnoDB AUTO_INCREMENT=4029998 DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `meituan_product_image` (
  ...
  KEY `imageurl` (`imageUrl`(255)) USING BTREE,
  KEY `threadid_status_failtimes` (`threadid`,`status`,`failtimes`)
) ENGINE=InnoDB AUTO_INCREMENT=1051240 DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=1412727 DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Table structure for table `prodb_1381007_change_product_task`
--

DROP TABLE IF EXISTS `prodb_1381007_change_product_task`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `prodb_1381007_change_product_task` (
  `id` bigint(20) unsigned NOT NULL AUTO_INCREMENT,
  `productid` bigint(20) NOT NULL,
  `feedid` bigint(20) NOT NULL,
  `tasktype` enum('delete','update','add') DEFAULT NULL,
...
--
-- Table structure for table `prodb_1381007_error_product`
--

DROP TABLE IF EXISTS `prodb_1381007_error_product`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `prodb_1381007_error_product` (
  `id` bigint(20) unsigned NOT NULL AUTO_INCREMENT,
  `productid` bigint(20) NOT NULL,
  `feedid` bigint(20) NOT NULL,
  `ucid` bigint(20) NOT NULL DEFAULT '0' COMMENT 'uc user id',
...
--
-- Table structure for table `prodb_1381007_product_attribute`
--

DROP TABLE IF EXISTS `prodb_1381007_product_attribute`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `prodb_1381007_product_attribute` (
  `id` bigint(20) NOT NULL,
  `productid` bigint(20) NOT NULL,
  `name` varchar(255) DEFAULT NULL,
  `value` text,
...
--
-- Table structure for table `prodb_1381007_product_feed`
--

DROP TABLE IF EXISTS `prodb_1381007_product_feed`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `prodb_1381007_product_feed` (
  `id` bigint(20) unsigned NOT NULL AUTO_INCREMENT,
  `productid` bigint(20) NOT NULL,
  `feedid` bigint(20) NOT NULL,
  `name` varchar(100) DEFAULT NULL,
...
--
-- Table structure for table `prodb_1381007_product_image`
--

DROP TABLE IF EXISTS `prodb_1381007_product_image`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `prodb_1381007_product_image` (
  `id` bigint(20) unsigned NOT NULL AUTO_INCREMENT,
  `productid` bigint(20) DEFAULT NULL,
  `imageUrl` varchar(1024) DEFAULT NULL,
  `imageBCSUrl` varchar(1024) DEFAULT NULL,
...
--
-- Table structure for table `prodb_1381007_product_info`
--

DROP TABLE IF EXISTS `prodb_1381007_product_info`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `prodb_1381007_product_info` (
  `id` bigint(20) unsigned NOT NULL,
  `feedid` bigint(20) unsigned NOT NULL,
  `name` varchar(255) NOT NULL,
  `title` text NOT NULL,
...
--
-- Table structure for table `prodb_1381007_product_line_validation`
--

DROP TABLE IF EXISTS `prodb_1381007_product_line_validation`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `prodb_1381007_product_line_validation` (
  `id` bigint(20) unsigned NOT NULL AUTO_INCREMENT,
  `productid` bigint(20) NOT NULL,
  `product_lineid` int(11) NOT NULL,
  `status` enum('error','warning','normal','unchecked') NOT NULL DEFAULT 'unchecked',
...
CREATE TABLE `test_product_attribute` (
  ...
  PRIMARY KEY (`id`),
  KEY `key` (`productid`)
) ENGINE=InnoDB AUTO_INCREMENT=49478 DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `test_product_image` (
  ...
  KEY `imageurl` (`imageUrl`(255)) USING BTREE,
  KEY `threadid_status_failtimes` (`threadid`,`status`,`failtimes`)
) ENGINE=InnoDB AUTO_INCREMENT=12137 DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=12113 DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
--
-- Table structure for table `uapi_info`
--

DROP TABLE IF EXISTS `uapi_info`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `uapi_info` (
  `apiid` bigint(20) NOT NULL COMMENT 'apiid for UAPI',
  `token` varchar(255) NOT NULL COMMENT 'empty string means all token',
  `apiname` varchar(255) NOT NULL COMMENT 'api name',
  `uapiclass` varchar(1024) NOT NULL COMMENT 'uapiclass string',
  `uparamsclass` varchar(1024) NOT NULL COMMENT 'uparamsclass string',
  `uresultclass` varchar(1024) NOT NULL COMMENT 'uresultclass string',
  PRIMARY KEY (`apiid`,`token`),
  KEY `apiname` (`apiname`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='uapi information/configuration table';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `vancl_product_image` (
  ...
  KEY `imageurl` (`imageUrl`(255)) USING BTREE,
  KEY `threadid_status_failtimes` (`threadid`,`status`,`failtimes`)
) ENGINE=InnoDB AUTO_INCREMENT=1051239 DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `vancl_product_line_validation` (
  ...
  UNIQUE KEY `validation` (`productid`,`product_lineid`),
  KEY `product_line` (`product_lineid`)
) ENGINE=InnoDB AUTO_INCREMENT=2728825 DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `weipin_product_image` (
  ...
  KEY `imageurl` (`imageUrl`(255)) USING BTREE,
  KEY `threadid_status_failtimes` (`threadid`,`status`,`failtimes`)
) ENGINE=InnoDB AUTO_INCREMENT=1028670 DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `weipin_product_line_validation` (
  ...
  UNIQUE KEY `validation` (`productid`,`product_lineid`),
  KEY `product_line` (`product_lineid`)
) ENGINE=InnoDB AUTO_INCREMENT=23383432 DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `wowotuan_product_image` (
  ...
  KEY `imageurl` (`imageUrl`(255)) USING BTREE,
  KEY `threadid_status_failtimes` (`threadid`,`status`,`failtimes`)
) ENGINE=InnoDB AUTO_INCREMENT=1051115 DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `wowotuan_product_line_validation` (
  ...
  UNIQUE KEY `validation` (`productid`,`product_lineid`),
  KEY `product_line` (`product_lineid`)
) ENGINE=InnoDB AUTO_INCREMENT=590469 DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `wuba_product_image` (
  ...
  KEY `imageurl` (`imageUrl`(255)) USING BTREE,
  KEY `threadid_status_failtimes` (`threadid`,`status`,`failtimes`)
) ENGINE=InnoDB AUTO_INCREMENT=1051236 DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `zouxiu_product_image` (
  ...
  KEY `imageurl` (`imageUrl`(255)) USING BTREE,
  KEY `threadid_status_failtimes` (`threadid`,`status`,`failtimes`)
) ENGINE=InnoDB AUTO_INCREMENT=894195 DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2012-08-22 11:06:33
